...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        concat: {
            merge_css: {
                src: ['src/<%=pkg.name %>.css', 'src/extensions/**/*.css'],
        ...
        cssmin: {
            add_banner: {
                ...
                files: {
                    ...
                    'dist/<%= pkg.name %>-all.min.css': ['src/<%=pkg.name %>.css', 'src/extensions/**/*.css']
                }
            }
        },
        copy: {
    ...
    grunt.registerTask('merge-css', 'merge all css files', function () {
        ...
        grunt.file.expand("src/extensions/**/*").forEach(function (dir) {
